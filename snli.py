...
# return data to build vocabulary - tuples with src and tgt
def snli_train_all():
...
def snli(directory='data/',
    ...
    **Citation:**
    ...
    """
    # download_and_save(url=url, directory=directory)
